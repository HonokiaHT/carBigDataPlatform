<template>
  <div class="content">
    <div class="md-layout">
      ...
      <ve-ring :data="salesPurpose_ringChart.data"
              :title="salesPurpose_ringChart.title" 
              :settings="salesPurpose_ringChart.settings"
              :legend="salesPurpose_ringChart.legend"
              ></ve-ring>
      <!-- <chart-card
